...
update tblCourse set course_name = 'FRAMEWORK을 활용한 빅데이터 개발자 전문 과정      '
where course_seq = 1;
update tblCourse set course_name = '웹 애플리케이션을 활용한 빅데이터 응용SW개발자 양성 '
where course_seq = 2;
update tblCourse set course_name = 'Web 보안엔지니어링 양성과정                                     '
where course_seq = 3;
update tblCourse set course_name = 'python java 응용SW실무개발자 양성 과정                  '
where course_seq = 4;
update tblCourse set course_name = '시큐어 코딩 web 애플리케이션 응용sw개발자 양성 과정 '
where course_seq = 5;
update tblCourse set course_name = '클라우드 컴퓨팅 기반의 Big Data 수집분석처리전문가   '
where course_seq = 6;
update tblCourse set course_name = 'Java Python 기반 응용SW 개발자 양성과정                '
where course_seq = 7;
update tblCourse set course_name = 'GITHUB 기반의 스프링을 활용한 프레임워크 구축 개발  '
where course_seq = 8;
update tblCourse set course_name = '웹기반 빅데이터 분석 응용SW개발자 양성과정               '
where course_seq = 9;
update tblCourse set course_name = '애자일 기법에 기반한 클라우드 Web어플리케이션 개발   '
where course_seq = 10;
